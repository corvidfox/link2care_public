...
# 2023-10-27: Combined data imported with 1610 rows and 1062 columns.
# Combined data last modified on OneDrive 2023-10-27 16:06:04 
```
...
# 2023-11-01: Variable Map imported with 1084 rows and 24 columns.
# Variable Map data last modified on OneDrive 2023-11-01 16:00:43 
```
...
variable_map <- variable_map %>%
  rename_at(
    ...
    ~c(
      ...
      "Bridge Data", "Label", "Value Labels", "Source List"
      )
    )
```
...
addWorksheet(wb, "L2C Variable Map")

writeDataTable(wb, 1, variable_map,
                startCol = 1, startRow = 1, 
                tableStyle = "TableStyleMedium9"
                )

saveWorkbook(wb, variable_map_path, overwrite = TRUE)
```
...
saveRDS(combined_data, rds_path)
