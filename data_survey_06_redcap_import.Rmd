...
* Question 27 on the tobacco questionnaire. Need to fix this. This variable wasn't previously in QDS. I need to go back and see how the changes Joe made to it affect the QDS data now before moving on. 




```{r}
redcap %>% select(visit_gender, gender)
```

```{r}
redcap %>% 
  select(-ii_v1, -visit_v1)
```
