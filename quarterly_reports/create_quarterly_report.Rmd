...
```{r}
master_log_path <- "../data/ignored/Master Log (version2).xlsx"
phone_term_path <- "../data/ignored/Link2Care Phone Terminations.xlsx"
ema_initial_pay_approach_path <- "../data/ignored/ema_initial_pay_approach.Rds"
ema_15_day_path <- "../data/ignored/15_Day_EMA.xlsx"
arrest_path <- "../data/ignored/current_arrest_data.xlsx"
bridge_path <- "../data/ignored/bridge_session_minutes.xlsx"
```
...
```{r}
ema_initial_pay_approach <- read_rds(ema_initial_pay_approach_path)
...
# 2023-06-20: EMA initial pay approach data imported with 47 rows and 14 columns.
...
table_12_ft <- flextable(table_12) %>% 
  my_ft_theme() |> 
  # Need font size 10 for the table to fit on the page.
