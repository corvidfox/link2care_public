...
Click "Run All Chunks Below" to crete the  quarterly report as a Word document.
...
# 2021-05-11: Master log imported with 283 rows and 33 columns.
```
...
# 2021-05-11: Master log screened out imported with 46 rows and 12 columns.
```
...
```{r}
n_ccsum(master_log_screened_in$n_clincards, na.rm = TRUE)
```
...
```{r}
n_phone_terminations <- nrow(phone_terminations)
```
...
Table 8. COVID-19 phone interviews (N=61) since protocol change on 3/17/2020. 
