...
```{r}
path <- "/Volumes/link2Care/Live Documents/L2C_Master_Log.xlsm"
```
...
# 2021-11-04: Master log screened in imported with 325 rows and 41 columns.
```
...
```{r}
path <- "/Volumes/Link2Care/Participant Data/R Data/master_log_screened_in.rds"
```
...
```{r}
path <- "/Volumes/Link2Care/Participant Data/R Data/master_log_screened_out.rds"
```
...
# 2021-04-28: Master log cleaned with 279 rows and 33 columns.
```
