...
# 2023-12-15: Combined data imported with 1606 rows and 1020 columns.
...
# 2023-12-15: Variable Map imported with 979 rows and 19 columns.
...
# 2023-12-15: Master log imported with 442 rows and 35 columns.
...
# 2023-12-15: Visit Window Data imported with 442 rows and 18 columns.
...
# 2023-12-15: Master log imported with 15 rows and 2 columns.
...
```{r}
# Inputs last modified: 2023-12-14
...
The master value for age was the calculated age, the master value for Hispanic origin was the subjective response in the screening instrument, and the gender variable was the subjective response (which had no deviation from the master log).
