...
# 2024-01-08: Combined data imported with 1606 rows and 1020 columns.
...
# 2024-01-08: Variable Map imported with 979 rows and 19 columns.
...
# 2024-01-08: Master log imported with 442 rows and 35 columns.
...
# 2024-01-08: Visit Window Data imported with 442 rows and 18 columns.
...
# 2024-01-08: Master log imported with 15 rows and 2 columns.
...
We converted the field for gender into a factor.
  ...
  dplyr::mutate(
    subj_race_ethn = factor(
      ...
      labels = c(
        ...
        'Non-Hispanic White',
        'Non-Hispanic Black',
        'Non-Hispanic, Other (including Multiracial)'
        )
      ),
    subj_race = factor(
      subj_race,
