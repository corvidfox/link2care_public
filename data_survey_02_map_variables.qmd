...
# Data check:
# 2023-12-13: v1 imported with 442 rows and 810 columns.
# 2023-12-13: v2 imported with 406 rows and 213 columns.
# 2023-12-13: v3 imported with 273 rows and 542 columns.
# 2023-12-13: v4 imported with 207 rows and 598 columns.
# 2023-12-13: v5 imported with 178 rows and 649 columns.
```
...
```{r}
# Inputs last modified: 2023-12-13

data_stats_list <- retrieve_data_stats('qds_stats')
...
purrr::walk(
  ...
  .f = function(x) {
    ...
    df_nm <- paste0("v", x)
    df <- get(df_nm, envir = .GlobalEnv)
    data_stats <- data_stats_list[[x]]
    print(paste0(df_nm, ":"))
    print(
      data_mod_check(
        df = df,
        df_path_str = path,
        orig_path_str = data_stats$sav_path,
...
# 2023-12-13: REDCap imported with 119 rows and 845 columns.
...
data_stats <- retrieve_data_stats('redcap_stats')
...
# 2023-12-13: Master log imported with 442 rows and 13 columns.
...
# 2023-12-13: TLFB imported with 1768 rows and 21 columns.
...
data_stats <- retrieve_data_stats('tlfb_stats')
...
# 2023-12-13: Pre-processed DDT imported with 1768 rows and 4 columns.
# Pre-processed DDT data last modified on OneDrive 2023-12-13 13:01:03
```
...
data_stats <- retrieve_data_stats('ddt_pivot_stats')
...
This data was in a wide Subject format, rather than Subject-Visit key format, where::here variables were lists of dates.
...
# 2023-12-13: Pre-processed Arrest data imported with 442 rows and 10 columns.
# Pre-processed Arrest data last modified on OneDrive 2023-12-13 13:01:09
```
...
data_stats <- retrieve_data_stats('arrest_proc_stats')
...
# 2023-12-13: Pre-processed Bridge data imported with 334 rows and 61 columns.
# Pre-processed Bridge data last modified on OneDrive 2023-12-13 13:01:26
```
...
data_stats <- retrieve_data_stats('bridge_proc_stats')
...
vars_v1 <- v1 |>
    dplyr::select(all_of(starts_with(incl_keys$starts_with)),
...
flagged_vars <- flag_unmatching_variables(
  source_list, desired_vars, incl_keys, excl_keys
  )
...
source_maps <- vm_make_source_map(
  ...
  dplyr::mutate(variable = dplyr::if_else(variable == 'endtime_1', 'endtime', variable)
  ) |>
  # V2
  dplyr::full_join(vm_make_source_map(
    source_list, dropping, 2, 'v2', incl_keys, excl_keys
      ) |>
  dplyr::mutate(variable = dplyr::if_else(variable == 'endtime_2', 'endtime', variable)
         ), 
  by = "variable"
  ) |>
  # V3
  ...
  dplyr::mutate(variable = dplyr::if_else(variable == 'endtime_3', 'endtime', variable)
         ),
  by = "variable"
  ) |>
  # V4
  ...
  dplyr::mutate(variable = dplyr::if_else(variable == 'endtime_4', 'endtime', variable)
         ),
  by = "variable"
  ) |>
  # V5
  ...
  dplyr::mutate(variable = dplyr::if_else(variable == 'endtime_5', 'endtime', variable)
         ),
  by = "variable"
  ) |>
  # REDCAP
...
inst_map <- vm_create_for_instrument('Administrative', desired_vars) |>
   dplyr::left_join(source_maps, by = 'variable')
...
```{r}
tlfb_vars <- tlfb |>
  dplyr::select(all_of(contains(c(
...
colnames(arrest_data)
 ...
 # [1] "id"                       "arrested_during_study"   
 # [3] "arrested_during_followup" "v1_v2_count"                
 # [5] "v2_v3_count"              "v3_v4_count"                
 # [7] "v4_v5_count"              "v5_end_count"               
 # [9] "v2_v5_total"              "v2_end_total" 
```
...
We modified our desired variables slightly, so that the 'arrest_' prefix would be consistently present.

```{r}
arrest_vars <- arrest_data |>
  dplyr::select(all_of(c(
    'arrested_during_study', 'arrested_during_followup',
...
desired_vars[desired_vars == 'arrested_during_study'] <- 'during_study'
desired_vars[desired_vars == 'arrested_during_followup'] <- 'during_followup'

desired_vars <- paste0("arrest_", desired_vars)

desired_vars

# [1] "arrest_during_study"    "arrest_during_followup"
# [3] "arrest_v1_v2_count"     "arrest_v2_v3_count"       
# [5] "arrest_v3_v4_count"     "arrest_v4_v5_count"       
# [7] "arrest_v5_end_count"    "arrest_v2_v5_total"    
# [9] "arrest_v2_end_total" 
```
...
#  [1] "subject"                   "reg_sessions_v1_v2"       
#  [3] "reg_minutes_v1_v2"         "reg_avg_duration_v1_v2"   
#  [5] "reg_sessions_v2_v3"        "reg_minutes_v2_v3"        
#  [7] "reg_avg_duration_v2_v3"    "reg_sessions_v3_v4"       
#  [9] "reg_minutes_v3_v4"         "reg_avg_duration_v3_v4"   
# [11] "reg_sessions_v4_v5"        "reg_minutes_v4_v5"        
# [13] "reg_avg_duration_v4_v5"    "reg_sessions_v2_v5"       
# [15] "reg_minutes_v2_v5"         "reg_avg_duration_v2_v5"   
# [17] "crisis_sessions_v1_v2"     "crisis_minutes_v1_v2"     
# [19] "crisis_avg_duration_v1_v2" "crisis_sessions_v2_v3"    
# [21] "crisis_minutes_v2_v3"      "crisis_avg_duration_v2_v3"
# [23] "crisis_sessions_v3_v4"     "crisis_minutes_v3_v4"     
# [25] "crisis_avg_duration_v3_v4" "crisis_sessions_v4_v5"    
# [27] "crisis_minutes_v4_v5"      "crisis_avg_duration_v4_v5"
# [29] "crisis_sessions_v2_v5"     "crisis_minutes_v2_v5"     
# [31] "crisis_avg_duration_v2_v5" "other_sessions_v1_v2"     
# [33] "other_minutes_v1_v2"       "other_avg_duration_v1_v2" 
# [35] "other_sessions_v2_v3"      "other_minutes_v2_v3"      
# [37] "other_avg_duration_v2_v3"  "other_sessions_v3_v4"     
# [39] "other_minutes_v3_v4"       "other_avg_duration_v3_v4" 
# [41] "other_sessions_v4_v5"      "other_minutes_v4_v5"      
# [43] "other_avg_duration_v4_v5"  "other_sessions_v2_v5"     
# [45] "other_minutes_v2_v5"       "other_avg_duration_v2_v5" 
# [47] "total_sessions_v1_v2"      "total_minutes_v1_v2"      
# [49] "total_avg_duration_v1_v2"  "total_sessions_v2_v3"     
# [51] "total_minutes_v2_v3"       "total_avg_duration_v2_v3" 
# [53] "total_sessions_v3_v4"      "total_minutes_v3_v4"      
# [55] "total_avg_duration_v3_v4"  "total_sessions_v4_v5"     
# [57] "total_minutes_v4_v5"       "total_avg_duration_v4_v5" 
# [59] "total_sessions_v2_v5"      "total_minutes_v2_v5"      
# [61] "total_avg_duration_v2_v5"
```
...
bridge_vars <- bridge_data |>
  dplyr::select(all_of(c(
    ...
    'crisis_sessions_v1_v2', 'crisis_minutes_v1_v2',
    'crisis_avg_duration_v1_v2', 'crisis_sessions_v2_v3',
    'crisis_minutes_v2_v3', 'crisis_avg_duration_v2_v3',
    'crisis_sessions_v3_v4', 'crisis_minutes_v3_v4',
    'crisis_avg_duration_v3_v4', 'crisis_sessions_v4_v5',
    'crisis_minutes_v4_v5', 'crisis_avg_duration_v4_v5',
    'crisis_sessions_v2_v5', 'crisis_minutes_v2_v5',
    'crisis_avg_duration_v2_v5', 'other_sessions_v1_v2', 
    'other_minutes_v1_v2', 'other_avg_duration_v1_v2', 
    'other_sessions_v2_v3', 'other_minutes_v2_v3', 
    'other_avg_duration_v2_v3', 'other_sessions_v3_v4', 
    'other_minutes_v3_v4', 'other_avg_duration_v3_v4', 
    'other_sessions_v4_v5', 'other_minutes_v4_v5', 
    'other_avg_duration_v4_v5', 'other_sessions_v2_v5', 
    'other_minutes_v2_v5', 'other_avg_duration_v2_v5', 
    'total_sessions_v1_v2', 'total_minutes_v1_v2', 
    'total_avg_duration_v1_v2', 'total_sessions_v2_v3', 
    'total_minutes_v2_v3', 'total_avg_duration_v2_v3', 
    'total_sessions_v3_v4', 'total_minutes_v3_v4', 
    'total_avg_duration_v3_v4', 'total_sessions_v4_v5', 
    'total_minutes_v4_v5', 'total_avg_duration_v4_v5', 
    'total_sessions_v2_v5', 'total_minutes_v2_v5', 
    'total_avg_duration_v2_v5' 
    ))
  ) |>
  names()
...
#  [1] "bridge_reg_sessions_v1_v2"        "bridge_reg_minutes_v1_v2"        
#  [3] "bridge_reg_avg_duration_v1_v2"    "bridge_reg_sessions_v2_v3"       
#  [5] "bridge_reg_minutes_v2_v3"         "bridge_reg_avg_duration_v2_v3"   
#  [7] "bridge_reg_sessions_v3_v4"        "bridge_reg_minutes_v3_v4"        
#  [9] "bridge_reg_avg_duration_v3_v4"    "bridge_reg_sessions_v4_v5"       
# [11] "bridge_reg_minutes_v4_v5"         "bridge_reg_avg_duration_v4_v5"   
# [13] "bridge_reg_sessions_v2_v5"        "bridge_reg_minutes_v2_v5"        
# [15] "bridge_reg_avg_duration_v2_v5"    "bridge_crisis_sessions_v1_v2"    
# [17] "bridge_crisis_minutes_v1_v2"      "bridge_crisis_avg_duration_v1_v2"
# [19] "bridge_crisis_sessions_v2_v3"     "bridge_crisis_minutes_v2_v3"     
# [21] "bridge_crisis_avg_duration_v2_v3" "bridge_crisis_sessions_v3_v4"    
# [23] "bridge_crisis_minutes_v3_v4"      "bridge_crisis_avg_duration_v3_v4"
# [25] "bridge_crisis_sessions_v4_v5"     "bridge_crisis_minutes_v4_v5"     
# [27] "bridge_crisis_avg_duration_v4_v5" "bridge_crisis_sessions_v2_v5"    
# [29] "bridge_crisis_minutes_v2_v5"      "bridge_crisis_avg_duration_v2_v5"
# [31] "bridge_other_sessions_v1_v2"      "bridge_other_minutes_v1_v2"      
# [33] "bridge_other_avg_duration_v1_v2"  "bridge_other_sessions_v2_v3"     
# [35] "bridge_other_minutes_v2_v3"       "bridge_other_avg_duration_v2_v3" 
# [37] "bridge_other_sessions_v3_v4"      "bridge_other_minutes_v3_v4"      
# [39] "bridge_other_avg_duration_v3_v4"  "bridge_other_sessions_v4_v5"     
# [41] "bridge_other_minutes_v4_v5"       "bridge_other_avg_duration_v4_v5" 
# [43] "bridge_other_sessions_v2_v5"      "bridge_other_minutes_v2_v5"      
# [45] "bridge_other_avg_duration_v2_v5"  "bridge_total_sessions_v1_v2"     
# [47] "bridge_total_minutes_v1_v2"       "bridge_total_avg_duration_v1_v2" 
# [49] "bridge_total_sessions_v2_v3"      "bridge_total_minutes_v2_v3"      
# [51] "bridge_total_avg_duration_v2_v3"  "bridge_total_sessions_v3_v4"     
# [53] "bridge_total_minutes_v3_v4"       "bridge_total_avg_duration_v3_v4" 
# [55] "bridge_total_sessions_v4_v5"      "bridge_total_minutes_v4_v5"      
# [57] "bridge_total_avg_duration_v4_v5"  "bridge_total_sessions_v2_v5"     
# [59] "bridge_total_minutes_v2_v5"       "bridge_total_avg_duration_v2_v5"
```
...
attribute_list <- variable_map |>
  ...
  dplyr::mutate(
    count = dplyr::n_distinct(c_across(ends_with("label")), na.rm=TRUE)
  ) |>
  dplyr::ungroup()
...
attribute_labels <- attribute_list |>
  ...
  dplyr::mutate(v1_label = dplyr::case_when(
    ...
    variable == 't_10' ~ paste(
      ...
      "hours (only include times where::here you wanted to quit smoking– do not",
  ...
  dplyr::mutate(v1_label = dplyr::if_else(is.na(v1_label), 
                            dplyr::case_when(
  ...
  dplyr::select(variable, attr_label)
```
...
if(logic_gate){
  attribute_labels <-attribute_labels |>
    dplyr::mutate(attr_label = dplyr::case_when(
      ...
      variable == 'heavy_drinking_days' ~ paste(
        "Total number of days where::here more than (4 alcoholic drinks", 
...
attribute_list <- attribute_list |>
  # Fill blanks with existing values, in preference order
  dplyr::rowwise() |>
  dplyr::mutate(v1_labels = dplyr::if_else(is.null(v1_labels), 
                             dplyr::case_when(
  ...
  dplyr::select(variable, attr_var_labels)
```

We combined these into a single attribute list.

```{r}
attribute_list <-  dplyr::left_join(attribute_labels, attribute_list, by='variable')
```
...
```{r}
variable_map <-  dplyr::left_join(variable_map, attribute_list, by = 'variable')
