...
# 2023-12-11: Master log imported with 442 rows and 13 columns.
...
data_mod_check(
  ...
  'mod_dt' = '2023-12-11 12:21:45 CST',
  'num_rows' = 1768,
  'num_cols' = 4,
...
data_mod_check(
  ...
  'mod_dt' = '2023-12-11 12:21:49 CST',
  'num_rows' = 442,
  'num_cols' = 10,
...
colnames(arrest_data)
 ...
 # [3] "arrested_during_followup" "v2_count"                
 # [5] "v3_count"                 "v4_count"                
 # [7] "v5_count"                 "end_count"               
...
arrest_vars <- arrest_data |>
  dplyr::select(all_of(c(
    ...
    'v2_count', 'v3_count', 'v4_count', 'v5_count', 'end_count',
    'v2_v5_total', 'v2_end_total'
    ))
  ) |>
  names()
...
# [3] "arrest_v2_count"        "arrest_v3_count"       
# [5] "arrest_v4_count"        "arrest_v5_count"       
# [7] "arrest_end_count"       "arrest_v2_v5_total"    
