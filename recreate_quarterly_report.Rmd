...
master_log_screened_in <- read_excel(
  ...
  col_types = c(
    "numeric", "text", "date", rep("text", 4), rep("text", 7), "date", "numeric", "text", "numeric", rep("text", 2), "numeric", "text", rep("numeric", 5), "skip", rep("numeric", 2)
  ),
  na = c("", ".", "N/A"),
  skip = 1
)
...
ggplot(baseline_per_month_by_year, aes(month_f, n, group = year_f)) +
  ...
  scale_y_continuous("Number of Participants Enrolled") +
  scale_color_manual("Year", values = c("#008744", "#0057e7", "#d62d20")) +
  theme_classic() 
```
