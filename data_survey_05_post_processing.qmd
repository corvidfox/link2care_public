...
# 2024-01-10: Combined data imported with 1606 rows and 1130 columns.
# Combined data last modified on OneDrive 2024-01-11 18:07:29
```
...
```{r}
# Inputs last modified: 2024-01-11
...
# 2024-01-11: Variable Map imported with 1149 rows and 21 columns.
# Variable Map data last modified on OneDrive 2024-01-11 18:07:29
```
...
variable_map <- variable_map  |>
 dplyr::mutate(
    skip_pattern = ifelse(
      calculated,
      'Calculated variable. Missing if source variable(s) missing', 
      skip_pattern)
    )
```
