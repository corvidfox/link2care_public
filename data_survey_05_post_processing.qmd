...
# 2023-11-20: Combined data imported with 1610 rows and 1063 columns.
# Combined data last modified on OneDrive 2023-10-27 15:54:38 
```
...
```{r}
# Inputs last modified: 2023-11-20
# 
data_mod_check(
  'df' = combined_data,
  ...
  'mod_dt' = '2023-10-27 15:54:38 CDT',
  'num_rows' = 1610,
  'num_cols' = 1063,
  'col_names' = c(
    'subject', 'group','visit',
...
# 2023-11-20: Variable Map imported with 1083 rows and 21 columns.
# Variable Map data last modified on OneDrive 2023-10-27 15:35:45 
```
...
```{r}
variable_map <- variable_map %>%
  add_column(skip_pattern = NA_character_)
...
```{r}
variable_map <- variable_map %>%
  add_column(source = NA_character_)
