...
# 2023-10-05: REDCap imported with 119 rows and 845 columns.
```
...
# 2023-10-05: Master log imported with 501 rows and 2 columns.
```
...
```{r}
dropping <- list('v1' = c(), 'v2' = c(), 'v3' = c(), 'v4' = c(), 'v5' = c())
```
...
```{r}
source_list <- list('v1' = v1, 'v2' = v2, 'v3' = v3, 'v4' = v4, 'v5' = v5)
```
...
We manually checked TEST_V4 in the visit 4 data set, and determined it should be dropped as well.
...
Each 'ENDTIME' variable required point-modification to ensure correct maping, as it evaded our standardization function.
...
# [22] "SQ_17"  "SQ_18"  "SQ_19"  "SQ_20"  "SQ_21"  "SQ_22"  "SQ_23" 
# [29] "SQ_18A" "SQ_18B" "SQ_18C" "SQ_18D" "SQ_18E" "SQ_18F" "SQ_18G"
# [36] "SQ_18H" "SQ_18I" "SQ_22A" "SQ_22B" "SQ_22C" "SQ_22D" "SQ_22E"
# [43] "SQ_22F" "SQ_22G" "SQ_22H"
```
...
# Warning: Warning: The following column name(s) could not be standardized because it/they would have created a duplicate column name: MMS_4_V5, MMS4_V5, MMS_4_V5A, MMS4_V5A, MMS_4_V5B, MMS4_V5B, MMS_4_V5C, MMS4_V5C, MMS_4_V5D, MMS4_V5D, MMS_4_V5E, MMS4_V5E, MMS_4_V5F, MMS4_V5F
# [1] "In source  v1 : mms_score, MMS_total, MMS_severity"  
# [2] "In source  v2 : "   
# [3] "In source  v3 : "                                            
# [4] "In source  v4 : "                                                 
# [5] "In source  v5 : MMS_1D_5, MMS_4_V5, MMS4_V5, MMS_4_V5A, MMS_4_V5B, MMS_4_V5C, MMS_4_V5D, MMS_4_V5E, MMS_4_V5F, MMS4_V5A, MMS4_V5B, MMS4_V5C, MMS4_V5D, MMS4_V5E, MMS4_V5F, mms_score_V5, MMS_total_V5, MMS_severity_V5"
```

We checked if any of these flagged variables contained only empty values, and found none.
These variables were manually checked.
The majority of the variables in the QDS V5 data set were due to unique naming differences that escaped our standardization function.
...
The others, such as `mms_score`, `MMS_total`, and `MMS_severity` were SPSS calculated variables we wished to drop and recreate in R.
...
We created our source maps, linking each source data set variable to the desired initially standardized variable name.
Several of the Visit 5 variables required point-corrections due to the unique naming issues evading our standardization function.
...
We checked for any variables that would either standardize differently, or were absent from the visit 1 source data set.
We identified both the variations of the SPSS calculated variables we wished to drop, and naming conventions which escaped our standardizing function.
...
# [1] "In source  v1 : height_meter_V1, height_meter_sq_V1, BMI_V1, weight_kg_V1, weight_status_V1, obese_V1, ovrwt_obese_V1" 
# [2] "In source  v2 : "             
# [3] "In source  v3 : HEIGHT_3, height_meter_V3, height_meter_sq_V3, WAIST_C3, BMI_V3, WEIGHT_3, weight_kg_V3, weight_status_V3, obese_V3, ovrwt_obese_V3"
# [4] "In source  v4 : height_meter_V4, height_meter_sq_V4, WAIST_C4, BMI_V4, WEIGHT_4, weight_kg_V4, weight_status_V4, obese_V4, ovrwt_obese_V4"
# [5] "In source  v5 : height_meter_V5, height_meter_sq_V5, WAIST_C5, BMI_V5, WEIGHT_5, weight_kg_V5, weight_status_V5, obese_V5, ovrwt_obese_V5" 
```
...
We checked for any variables that would either standardize differently, or were absent from the visit 1 source data set.
We manually verified this values and found that: - `DEMO16G` in visit 1 was mislabeled, and should map to `dem_14g` along with `DEM14GV3`, `DEM14GV4`, and `DEM14GV5` - `DEMO14HV3`, `DEMO14HV4`, and `DEMO14HV5` should map to `dem_14h`, as they correspond to an item that was first present in Visit 3.
...
We created our source maps, including the necessary point-mutation to ensure our desired mapping.
...
# [3] "In source  v3 : "                                     
# [4] "In source  v4 : "                                     
# [5] "In source  v5 : WELL_BEING1, WELL_BEING2, WELL_BEING3"
```
...
We examined the variables that had otherwise failed to be assigned from each QDS data set.
