...
We added these empty 'TEST' variables to the list of variables to exclude.
...
The 'GROUP' variable was added from QDS Visit 3 onward, and was desired.
...
The REDCap variables only containing missing values were dropped. We updated our desired variables to include the variables introduced in the REDCap data set, in our desired order.
...
#  [7] "ii"                "ctime"             "endtime"          
# [10] "etime"             "maca_mdd_complete" "ps_timestamp"     
# [13] "ps_complete"       "email" 
```
