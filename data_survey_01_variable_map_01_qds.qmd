...
We added these empty 'TEST' variables, as well as the empty `SUBJECT1` variable, to the list of variables to exclude.
...
We updated our desired variables to include the variables introduced in the REDCap data set, in our desired order.
