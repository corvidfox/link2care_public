...
```{r}
path <- "../Participant Data/SPSS Data/Redcap/All_Visits_Redcap.sav"
<<<<<<< HEAD
```
...
remove_list <- paste(c("TEST", "-948_TEST", "test2"), collapse = '|')
removed <-  redcap[grep(remove_list, redcap$record_id, invert = TRUE), ]
removed <- redcap %>% filter(!grepl(remove_list, redcap$record_id ))
rm(removed)
>>>>>>> master
```
...
<<<<<<< HEAD
# 2023-03-15: After dropping fake participant rows, REDCap Data contains 101 rows and 882 columns.
=======
# 2022-07-11: After dropping fake participant rows, REDCap Data contains 112 rows and 882 columns.

# 2023-03-15: After dropping fake participant rows, REDCap Data contains 112 rows and 882 columns.
>>>>>>> master
```
...
# 🔴After you get this to work, move this section. I want all of the variable naming to exist in the Rmd code. 
...
Review column names that don't have a match in the QDS redcap.
...
redcap <- redcap %>% 
  select(
    ...
    bh_25 = bh19v1, 
    bh_26 = bh20v, 
    brief_homelessness_questionnaire_complete, 
    sss_1 = sss1_v1, 
    sss_2 = sss2_v1, 
    macarthur_scale_complete, 
    phq_1 = phq1_v1, 
    phq_2 = phq2_v1, 
    phq_3 = phq3_v1, 
    phq_4 = phq4_v1, 
    ...
    phq_14 = phq14_v1, 
    phq_15 = phq15_v1, 
    patient_health_questionnaire_complete, 
    hs_1 = hs1_v1, 
    hs_2 = hs2_v1, 
    hs_3 = hs3_v1, 
    hs_4 = hs4_v1, 
    ...
    hs_11 = hs11_v1, 
    hs_12 = hs12_v1, 
    sf12_health_survey_complete, 
    hrq_1 = hrq1_v1, 
    hrq_2 = hrq2_v1, 
    hrq_3 = hrq3_v1, 
    health_related_quality_of_life_complete, 
    srh_1a = s2_v1___1, 
    srh_1b = s2_v1___2, 
    srh_1c = s2_v1___3, 
    srh_1d = s2_v1___4, 
    ...
    srh_52h = s43_v1___8, 
    srh_52i = s43_v1___9, 
    selfrated_health_questionnaire_complete, 
    ds_1 = ds1_v2, 
    ds_2 = ds2_v2, 
    ds_3 = ds3_v2, 
    ds_4 = ds4_v2, 
    ...
    ds_11a = ds11a_v2, 
    ds_11b = ds11b_v2, 
    tcu_drug_screen_5_complete, 
    ptsd_1 = ptsd1_v1, 
    ptsd_2 = ptsd2_v1, 
    ptsd_3 = ptsd3_v1, 
    ptsd_4 = ptsd4_v1, 
    pcptsd_screen_complete, 
    brac_1 = brac1, 
    brac_2 = brac2, 
    brac_3 = brac3, 
    brac_4 = brac4, 
    ...
    hsi_1 = hsi1_v1, 
    hsi_2 = hsi2_v13, 
    tobacco_history_complete, 
    brs_1 = brs1_v1, 
    brs_2 = brs2_v1, 
    brs_3 = brs3_v1, 
    brs_4 = brs4_v1, 
    brs_5 = brs5_v1, 
    brfss_inadequate_sleep_complete, 
    af_1 = af1_v1, 
    af_2m = af2m_v1, 
    af_3tu = af3tu_v1, 
    af_4w = af4w_v1, 
    ...
    af_9b = af9b_v1, 
    af_9c = af9c_v1, 
    alcohol_quantity_and_frequency_complete, 
    pbq_1 = pbq1, 
    pbq_2 = pbq2, 
    pbq_3 = pbq3, 
    pbq_4 = pbq4, 
    ...
    pbq_6 = pbq6, 
    pbq_7 = pbq7, 
    personality_beliefs_questionnaire_complete, 
    fss_1 = fss1_v2, 
    fss_2 = fss2_v2, 
    fss_3 = fss3_v2, 
    fss_3a = fss3a_v2, 
    fss_4 = fss4_v2, 
    fss_5 = fss5_v2, 
    usda_food_insecurity_survey_complete, 
    ms_1 = ms1_v1, 
    ms_2 = ms2_v1, 
    ms_3 = ms3_v1, 
    ms_4 = ms8_v1, 
    meal_survey_complete, 
    cj_1 = cj1_v2, 
    cj_2 = cj2_v2, 
    cj_3 = cj3_v2, 
    cj_4 = cj4_v2, 
    ...
    cj_39 = cj39_v2, 
    cj_40 = cj40_v2, 
    tcu_client_evaluation_complete, 
    sb_1 = sb1_v1, 
    sb_2 = sb2_v1, 
    sb_3 = sb3_v1, 
    sb_4 = sb4_v1, 
    ...
    sb_8 = sb8_v1, 
    sb_9 = sb9_v1, 
    sexual_behaviors_complete, 
    vac_1 = vac1, 
    vac_2 = vac2, 
    vac_3 = vac3, 
    covid19_vaccine_complete, 
    dd_1 = dd1_v1, 
    dd_2 = dd2_v1, 
    dd_3 = dd3_v1, 
    dd_4 = dd4_v1, 
    ...
    dd_9 = dd9_v1, 
    dd_10 = dd10_v1, 
    detroit_area_study_assessment_complete, 
    mmd_1a = mmd1a, 
    mmd_1b = mmd1b, 
    mmd_1c = mmd1c, 
    mmd_1d = mmd1d, 
    ...
    uls_20 = uls20_v2, 
    uls_21 = uls21_v2, 
    urban_life_stressor_scale_complete, 
    pv_1 = pv1_v2, 
    pv_2 = pv2_v2, 
    pv_3 = pv3_v2, 
    personal_victimization_complete, 
    ps_1 = ps1_v2, 
    ps_2 = ps2_v2, 
    ps_3 = ps3_v2, 
    ps_4 = ps4_v2, 
    ...
    dts_15 = dts15_v2, 
    dts_16 = dts16_v2, 
    distress_tolerance_scale_complete, 
    aq_1 = aq1_v1, 
    aq_2 = aq2_v1, 
    aq_3 = aq3_v1, 
    aq_4 = aq4_v1, 
    ...
    aq_11 = aq11_v1, 
    aq_12 = aq12_v1, 
    negative_affect_aggression_aq12_complete, 
    ces_1 = ces1_v1, 
    ces_2 = ces2_v1, 
    ces_3 = ces3_v1, 
    ces_4 = ces4_v1, 
    ...
    is_11 = is11_v1, 
    is_12 = is12_v1, 
    interpersonal_support_evaluation_list_complete, 
    rp_1 = rp1_v1, 
    rp_2 = rp2_v1, 
    religious_participation_complete, 
    lsn_1 = lsn1_v1, 
    lsn_2 = lsn2_v1, 
    lsn_3 = lsn3_v1, 
    lsn_4 = lsn4_v1, 
    ...
    r_16n = r15_v1___14, 
    r_16o = r15_v1___15, 
    resource_utilization_questionnaire_complete, 
    bpm_1 = bpm1_v1, 
    bpm_2 = bpm2_v1, 
    bpm_3 = bpm3_v1, 
    bpm_4 = bpm4_v1, 
    ...
    bpm_5f = bpm5_v1___5, 
    bpm_5g = bpm5_v1___6, 
    barriers_to_phone_based_case_management_complete, 
    tq_1_1 = tq1_1v3, 
    tq_2_1 = tq2_1v3, 
    tq_14_1 = tq14_1v3, 
    tq_1_2 = tq1_2v3, 
    ...
    tq_13_3 = tq13_3v3, 
    tq_14_3 = tq14_3v3, 
    treatment_and_quality_satisfaction_survey_complete, 
    staffperc_q1, 
    staff_perceptions_of_the_link2care_app_complete, 
    everything()
  )
```
...
# 2023-03-20: REDCap cleaned with 101 rows and 879 columns.
=======
  "REDCap redcap cleaned with", nrow(redcap), "rows and", ncol(redcap), "columns.\n"
)

# 2022-07-11: REDCap redcap cleaned with 21 rows and 911 columns.
>>>>>>> master
```


# 💾Save the redcap frame

```{r}
path <- "../Participant Data/R data/redcap_import.rds"
```
