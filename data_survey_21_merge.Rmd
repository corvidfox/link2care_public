...
2022-03-07: Not running this section of code. Attempting to merge all the data frames without losing the labels. https://stackoverflow.com/questions/61489740/if-else-with-haven-labelled-column-fails-because-of-wrong-class
...
# 2021-08-17: Combined Participant data cleaned with 1080 rows and 1202 columns.
```
