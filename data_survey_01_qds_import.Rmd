...
walk(
  ...
  .f = function(x) {
    ...
    cat(
      sav_nm, "last modified on UTHealth server:", as.character(file.info(path)$mtime), "\n"
    )
  }
)
```
...
# 2021-07-19: v1 imported with 295 rows and 810 columns.
# 2021-07-19: v2 imported with 271 rows and 210 columns.
# 2021-07-19: v3 imported with 194 rows and 542 columns.
# 2021-07-19: v4 imported with 145 rows and 598 columns.
# 2021-07-19: v5 imported with 133 rows and 639 columns.
```
...
### v4: Reorder columnn names and manual changes
...
### v5: Reorder columnn names and manual changes

**NOTE:** Spoke with James and Joe on 2021-07-19. V5 will have a VISIT_TYPE column, but not until they actually give a participant a follow-up using the V5 QDS.

```{r}
v5 <- v5 %>% 
  select(
    TODAY_V5, II_V5, SUBJECT, GROUP, VISIT_V5, TEST_V5, 
...
# 2021-07-19: QDS data imported and merged with 1038 rows and 1046 columns.
```
...
```{r}
rds_path <- "/Volumes/Link2Care/Participant Data/R Data/qds_all_visits_import.rds"
write_rds(qds_all_visits, rds_path)

# Michael also wants an SPSS version
spss_path <- "/Volumes/Link2Care/Participant Data/SPSS Data/QDS Data/qds_all_visits_import.SAV"
